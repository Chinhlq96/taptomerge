...
public class LocalizationEditor : MetaEditor {
    ...
    public override void OnInspectorGUI () {
        ...
        if (language == null) {
            language = LocalizationAssistant.Instance.languages[0];
            OnEnable();
        }
        ...
        List<string> languages = LocalizationAssistant.Instance.languages.Select(x => x.ToString()).ToList();
...
//                            }
        ...
        foreach (string key in phrases.Keys) {
            ...
            string text = GUILayout.TextArea(phrases[key], EditorStyles.textArea, GUILayout.Width(300));
    ...
    public override UnityEngine.Object FindTarget() {
        ...
        return LocalizationAssistant.Instance;
    }
}
