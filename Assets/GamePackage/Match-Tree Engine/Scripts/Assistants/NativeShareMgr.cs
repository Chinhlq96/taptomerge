...
{
    [SerializeField]
    public string subject = "Share Next Floor";
    [SerializeField]
    public string textShare = "Congratulations, I have good score in Next Floor Game! Can you beat me? #NextFloorGame ";
    [SerializeField]
    public string urlAndroid = "http://bit.ly/2m8CAIx";
    [SerializeField]
    public string urlIOS = "http://apple.co/2m5PSVz";
